/* empty css              */(function(){const l=document.createElement("link").relList;if(l&&l.supports&&l.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const r of t.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function s(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function a(e){if(e.ep)return;e.ep=!0;const t=s(e);fetch(e.href,t)}})();const c=!1,n="http://localhost:3000/fantasticArticles",o="./data/fantasticArticles.json";async function d(){var i;try{const l=await fetch(c?n:o);if(!l.ok)throw new Error("Failed to load fantastic articles");const s=await l.json();(Array.isArray(s)?((i=s[0])==null?void 0:i.fantasticArticles)??s:s.fantasticArticles??s).forEach(e=>{const t=`
<div
