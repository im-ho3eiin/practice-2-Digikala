...
<div
                  ...
                  <div class="w-full flex flex-col">
                    <div class="w-full mb-1 relative flex items-center justify-center">
                      <img class="w-[240px] h-[240px]" src="${l.image}" alt="">
                    ...
                    <div
                      ...
                      <div
                        class="w-full font-iranYekanBold text-[11px] leading-[23.87px] text-neutral-700 line-clamp-2 overflow-hidden">${l.title}</div>
                      <div class="w-full mb-1 flex flex-row items-center justify-end">
                        <div class="flex flex-row items-center justify-center">
                          <div class="font-iranYekanBold text-[11px] leading-[23.87px] text-neutral-700">${l.score}</div>
                      ...
                      <div class="w-full pt-1 flex flex-col">
                        ...
                        <div class="pl-5 flex items-center justify-end">
                          <del
                            class="font-iranYekan text-[11px] text-[rgb(192,194,197)] leading-[23.87px]">${l.realPrice}</del>
                        </div>
                      </div>
      ...
      `;document.querySelector("#fantastic-articles").insertAdjacentHTML("beforeend",i)})}).catch(s=>console.log(s));
