...
fetch('http://localhost:3000/fantasticArticles')
  .then(res => { return res.json(); })
  .then(data => {
    data.forEach(fantasticArticle => {
      const article = `
<div
      ...
      document.querySelector('#fantastic-articles').insertAdjacentHTML('beforeend', article)
    })
  })
